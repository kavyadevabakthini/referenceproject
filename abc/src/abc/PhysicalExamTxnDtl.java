...
public class PhysicalExamTxnDtl implements Serializable {
	...
	@Column(name="physical_exam_txn_id")
	private int physicalExamTxnId;
	...
	public int getPhysicalExamTxnId() {
		return this.physicalExamTxnId;
	}

	public void setPhysicalExamTxnId(int physicalExamTxnId) {
		this.physicalExamTxnId = physicalExamTxnId;
	}
